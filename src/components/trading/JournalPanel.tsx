        ...
        {activeReviewEntry ? (
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              <button onClick={saveReview} style={{ ...monoStyle, fontSize: 12, fontWeight: 700, padding: "8px 12px", border: "1px solid var(--signal-core)", borderRadius: 6, background: "rgba(0, 200, 5, 0.12)", color: "var(--signal-core)", cursor: "pointer" }}>
                SAVE REVIEW
              </button>
