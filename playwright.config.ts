...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: "public",
      testMatch: /(public-pages|marketing-screenshots|academy-flow)\.spec\.ts/,
    ...
    {
      name: "chromium",
      testIgnore: [/public-pages\.spec\.ts/, /marketing-screenshots\.spec\.ts/, /academy-flow\.spec\.ts/, /auth-flows\.spec\.ts/],
