...
const TIERS: Tier[] = [
  {
    ...
    features: [
      "Guided learning academy with beginner-to-expert badge paths",
      "Daily/weekly learning streaks and reminder preferences",
      ...
      "Strategy simulator lessons for covered calls, puts, and spread execution",
    ],
    tier: "free",
  },
  {
    ...
    features: [
      ...
      "Day trading activity monitor (volume, insider clusters, short interest)",
      "Social sentiment analysis (StockTwits + Reddit + FinTwit)",
      "Signal backtester (3-month history)",
      "AI chat (15 messages/day)",
      "5 watchlists, 50 tickers each",
      "All push notifications",
      "Advanced simulator walkthroughs and badge progression support",
    ],
    trial: true,
    tier: "starter",
  },
