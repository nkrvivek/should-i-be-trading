...
export const WORKFLOW_PRESETS: Record<WorkflowProfile, WorkflowPreset> = {
  beginner: {
    summary: "Start with simulator reps before pushing into live execution. The app should slow you down and make the next step obvious.",
    stanceCopy: "Start with the tape, keep the process simple, and only move into review when the ticker and regime align. Simulate first, trade last.",
