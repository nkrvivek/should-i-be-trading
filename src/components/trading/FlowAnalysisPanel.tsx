    ...
    <div>
      ...
      {data && (
        <>
          ...
          {/* Supports */}
          <FlowSection title="Flow Supports Position" entries={data.supports} color="var(--signal-core, #00c805)" emptyText="No supporting flow detected" />
              ...
              <tr key={e.ticker} style={{ borderBottom: "1px solid var(--border-dim)" }}>
                ...
                <td style={{ padding: "8px 10px" }}>
                  <span style={{
                    ...
                    fontSize: 12,
                    fontWeight: 600,
                    background: e.flow_class === "accum" ? "rgba(0, 200, 5, 0.1)" : e.flow_class === "distrib" ? "rgba(232, 93, 108, 0.1)" : "#f1f5f9",
